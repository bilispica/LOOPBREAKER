...
var l091D098F_0 = false;
l091D098F_0 = instance_exists(obj_pot2_1);
if(l091D098F_0)
{
	/// @DnDAction : YoYo Games.Instances.If_Instance_Exists
	/// @DnDVersion : 1
	...
	var l789E5E9A_0 = false;
	l789E5E9A_0 = instance_exists(obj_pot2_2);
	if(l789E5E9A_0)
	{
		/// @DnDAction : YoYo Games.Common.If_Variable
		/// @DnDVersion : 1
...
if(sp == 1)
{
	...
	if(x == 120)
	{
		...
		/// @DnDArgument : "objectid" "obj_thorn_s"
		/// @DnDArgument : "layer" ""ins_thorn_s""
		/// @DnDSaveInfo : "objectid" "obj_thorn_s"
		instance_create_layer(x + 0, y + 0, "ins_thorn_s", obj_thorn_s);
		...
		if(x <= 1680)
		{
			...
			if(!(global.g_move_l == 0))
			{
				...
				if(x == 1560)
				{
					...
					instance_create_layer(120+obk_player.xspeed, y + 0, "ins_thorn", obj_thorn);
				}
			...
			if(!(global.g_move_r == 0))
			{
				...
				if(x == 240)
				{
					...
					/// @DnDArgument : "layer" ""ins_thorn""
					/// @DnDSaveInfo : "objectid" "obj_thorn"
					instance_create_layer(1680-obk_player.xspeed, y + 0, "ins_thorn", obj_thorn);
				}
