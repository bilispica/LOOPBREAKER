...
if(sp == 1)
{
	...
	if(x == 120)
	{
		...
		/// @DnDArgument : "objectid" "obj_pot_1s"
		/// @DnDArgument : "layer" ""ins_pot_s""
		/// @DnDSaveInfo : "objectid" "obj_pot_1s"
		instance_create_layer(x + 0, y + 0, "ins_pot_s", obj_pot_1s);
		...
		if(x <= 1680)
		{
			...
			if(!(global.g_move_l == 0))
			{
				...
				if(x == 1560)
				{
					...
					/// @DnDArgument : "ypos_relative" "1"
					/// @DnDArgument : "objectid" "obj_pot_1"
					/// @DnDArgument : "layer" ""Ins_pot""
					/// @DnDSaveInfo : "objectid" "obj_pot_1"
					instance_create_layer(120+obk_player.xspeed, y + 0, "Ins_pot", obj_pot_1);
				}
			...
			if(!(global.g_move_r == 0))
			{
				...
				if(x == 240)
				{
					...
					/// @DnDArgument : "layer" ""Ins_pot""
					/// @DnDSaveInfo : "objectid" "obj_pot_1"
					instance_create_layer(1680-obk_player.xspeed, y + 0, "Ins_pot", obj_pot_1);
				}
		...
		if(obk_player.stop == 0)
		{
			...
			if(obk_player.x == x+60)
			{
				...
				if(obk_player.y == y+120)
				{
					...
					/// @DnDHash : 2E52CAD6
					/// @DnDParent : 3B9A76A0
					/// @DnDArgument : "obj" "obj_B_1"
					/// @DnDArgument : "not" "1"
					/// @DnDSaveInfo : "obj" "obj_B_1"
					var l2E52CAD6_0 = false;
					l2E52CAD6_0 = instance_exists(obj_B_1);
					if(!l2E52CAD6_0)
					{
						/// @DnDAction : YoYo Games.Instances.Create_Instance
						/// @DnDVersion : 1
						...
						/// @DnDArgument : "objectid" "obj_B_1"
						/// @DnDArgument : "layer" ""Ins_pot_s""
						/// @DnDSaveInfo : "objectid" "obj_B_1"
						instance_create_layer(obk_player.x, obk_player.y-240, "Ins_pot_s", obj_B_1);
					}
				}
			}
		}
...
if(!(obk_player.x == x+60))
{
	...
	/// @DnDArgument : "obj" "obj_B_1"
	/// @DnDSaveInfo : "obj" "obj_B_1"
	var l50208120_0 = false;
	l50208120_0 = instance_exists(obj_B_1);
	if(l50208120_0)
	{
		/// @DnDAction : YoYo Games.Instances.Destroy_Instance
		/// @DnDVersion : 1
...
if(!(obk_player.y == y+120))
{
	...
	/// @DnDArgument : "obj" "obj_B_1"
	/// @DnDSaveInfo : "obj" "obj_B_1"
	var l5B5EBD31_0 = false;
	l5B5EBD31_0 = instance_exists(obj_B_1);
	if(l5B5EBD31_0)
	{
		/// @DnDAction : YoYo Games.Instances.Destroy_Instance
		/// @DnDVersion : 1
