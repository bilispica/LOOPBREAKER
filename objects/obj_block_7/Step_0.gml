...
var l7B0ABEFC_0 = false;
l7B0ABEFC_0 = instance_exists(obj_pot2_1);
if(l7B0ABEFC_0)
{
	/// @DnDAction : YoYo Games.Instances.If_Instance_Exists
	/// @DnDVersion : 1
	...
	var l5AC18BE3_0 = false;
	l5AC18BE3_0 = instance_exists(obj_pot2_2);
	if(l5AC18BE3_0)
	{
		/// @DnDAction : YoYo Games.Common.If_Variable
		/// @DnDVersion : 1
...
if(sp == 1)
{
	...
	if(x == 120)
	{
		...
		/// @DnDArgument : "objectid" "obj_block_7s"
		/// @DnDArgument : "layer" ""ins_cloud_s""
		/// @DnDSaveInfo : "objectid" "obj_block_7s"
		instance_create_layer(x + 0, y + 0, "ins_cloud_s", obj_block_7s);
		...
		if(x <= 1680)
		{
			...
			if(!(global.g_move_l == 0))
			{
				...
				if(x == 1560)
				{
					...
					/// @DnDArgument : "ypos_relative" "1"
					/// @DnDArgument : "objectid" "obj_block_7"
					/// @DnDArgument : "layer" ""ins_cloud""
					/// @DnDSaveInfo : "objectid" "obj_block_7"
					instance_create_layer(120+obk_player.xspeed, y + 0, "ins_cloud", obj_block_7);
				}
			...
			if(!(global.g_move_r == 0))
			{
				...
				if(x == 240)
				{
					...
					/// @DnDArgument : "layer" ""ins_cloud""
					/// @DnDSaveInfo : "objectid" "obj_block_7"
					instance_create_layer(1680-obk_player.xspeed, y + 0, "ins_cloud", obj_block_7);
				}
