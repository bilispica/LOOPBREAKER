...
var l412876D9_0 = false;
l412876D9_0 = instance_exists(obj_pot2_1);
if(l412876D9_0)
{
	/// @DnDAction : YoYo Games.Instances.If_Instance_Exists
	/// @DnDVersion : 1
	...
	var l5C7B347D_0 = false;
	l5C7B347D_0 = instance_exists(obj_pot2_2);
	if(l5C7B347D_0)
	{
		/// @DnDAction : YoYo Games.Common.If_Variable
		/// @DnDVersion : 1
...
if(sp == 1)
{
	...
	if(x == 120)
	{
		...
		/// @DnDArgument : "objectid" "obj_light_2s"
		/// @DnDArgument : "layer" ""ins_light_s""
		/// @DnDSaveInfo : "objectid" "obj_light_2s"
		instance_create_layer(x + 0, y + 0, "ins_light_s", obj_light_2s);
		...
		if(x <= 1680)
		{
			...
			if(!(global.g_move_l == 0))
			{
				...
				if(x == 1560)
				{
					...
					instance_create_layer(120+obk_player.xspeed, y + 0, "ins_light", obj_light_2);
				}
			...
			if(!(global.g_move_r == 0))
			{
				...
				if(x == 240)
				{
					...
					/// @DnDArgument : "layer" ""ins_light""
					/// @DnDSaveInfo : "objectid" "obj_light_2"
					instance_create_layer(1680-obk_player.xspeed, y + 0, "ins_light", obj_light_2);
				}
