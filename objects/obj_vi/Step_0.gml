...
if(obj_opi.lan == 3)
{
	...
	if(obj_opi.scr == 0)
	{
		...
		/// @DnDHash : 69257B33
		/// @DnDParent : 67EDA297
		/// @DnDArgument : "spriteind" "spr_v_z_1"
		/// @DnDSaveInfo : "spriteind" "spr_v_z_1"
		sprite_index = spr_v_z_1;
		image_index = 0;
	}
	...
	if(obj_opi.scr == 1)
	{
		...
		/// @DnDHash : 02F60C6C
		/// @DnDParent : 4DE9DF8D
		/// @DnDArgument : "spriteind" "spr_v_z"
		/// @DnDSaveInfo : "spriteind" "spr_v_z"
		sprite_index = spr_v_z;
		image_index = 0;
	}
}