...
var l4C455956_0 = false;
l4C455956_0 = instance_exists(obj_pot2_1);
if(l4C455956_0)
{
	/// @DnDAction : YoYo Games.Instances.If_Instance_Exists
	/// @DnDVersion : 1
	...
	var l77FA6931_0 = false;
	l77FA6931_0 = instance_exists(obj_pot2_2);
	if(l77FA6931_0)
	{
		/// @DnDAction : YoYo Games.Common.If_Variable
		/// @DnDVersion : 1
...
if(sp == 1)
{
	...
	if(x == 120)
	{
		...
		/// @DnDArgument : "objectid" "obj_block_2s"
		/// @DnDArgument : "layer" ""ins_block_s""
		/// @DnDSaveInfo : "objectid" "obj_block_2s"
		instance_create_layer(x + 0, y + 0, "ins_block_s", obj_block_2s);
		...
		if(x <= 1680)
		{
			...
			if(!(global.g_move_l == 0))
			{
				...
				if(x == 1560)
				{
					...
					/// @DnDArgument : "ypos_relative" "1"
					/// @DnDArgument : "objectid" "obj_block_2"
					/// @DnDArgument : "layer" ""ins_block""
					/// @DnDSaveInfo : "objectid" "obj_block_2"
					instance_create_layer(120+obk_player.xspeed, y + 0, "ins_block", obj_block_2);
				}
			...
			if(!(global.g_move_r == 0))
			{
				...
				if(x == 240)
				{
					...
					/// @DnDArgument : "layer" ""ins_block""
					/// @DnDSaveInfo : "objectid" "obj_block_2"
					instance_create_layer(1680-obk_player.xspeed, y + 0, "ins_block", obj_block_2);
				}
